...
var PRECACHE = [
  ...
  "./css/styles.css?v=50",
  "./js/sign-lang.js?v=50",
  "./js/orbita-world-map.js?v=50",
  "./js/questions-data.js?v=50",
  "./js/country-questions-data.js?v=50",
  "./js/bosses-data.js?v=50",
  "./js/chain-data.js?v=50",
  "./js/boss-maps.js?v=50",
  "./js/game.js?v=50",
  "./js/access-gate.js?v=50",
  "./assets/d3.min.js",
