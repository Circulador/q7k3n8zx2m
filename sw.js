...
var PRECACHE = [
  ...
  "./css/styles.css?v=62",
  "./js/sign-lang.js?v=62",
  "./js/orbita-world-map.js?v=62",
  "./js/questions-data.js?v=62",
  "./js/country-questions-data.js?v=62",
  "./js/bosses-data.js?v=62",
  "./js/chain-data.js?v=62",
  "./js/boss-maps.js?v=62",
  "./js/game.js?v=62",
  "./js/access-gate.js?v=62",
  "./assets/d3.min.js",
