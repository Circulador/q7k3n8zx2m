...
var PRECACHE = [
  ...
  "./css/styles.css?v=58",
  "./js/sign-lang.js?v=58",
  "./js/orbita-world-map.js?v=58",
  "./js/questions-data.js?v=58",
  "./js/country-questions-data.js?v=58",
  "./js/bosses-data.js?v=58",
  "./js/chain-data.js?v=58",
  "./js/boss-maps.js?v=58",
  "./js/game.js?v=58",
  "./js/access-gate.js?v=58",
  "./assets/d3.min.js",
