...
var PRECACHE = [
  ...
  "./css/styles.css?v=61",
  "./js/sign-lang.js?v=61",
  "./js/orbita-world-map.js?v=61",
  "./js/questions-data.js?v=61",
  "./js/country-questions-data.js?v=61",
  "./js/bosses-data.js?v=61",
  "./js/chain-data.js?v=61",
  "./js/boss-maps.js?v=61",
  "./js/game.js?v=61",
  "./js/access-gate.js?v=61",
  "./assets/d3.min.js",
