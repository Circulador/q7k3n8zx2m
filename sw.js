...
var PRECACHE = [
  ...
  "./css/styles.css?v=68",
  "./js/sign-lang.js?v=68",
  "./js/orbita-world-map.js?v=68",
  "./js/questions-data.js?v=68",
  "./js/country-questions-data.js?v=68",
  "./js/bosses-data.js?v=68",
  "./js/chain-data.js?v=68",
  "./js/boss-maps.js?v=68",
  "./js/game.js?v=68",
  "./js/access-gate.js?v=68",
  "./assets/d3.min.js",
