...
var PRECACHE = [
  ...
  "./css/styles.css?v=63",
  "./js/sign-lang.js?v=63",
  "./js/orbita-world-map.js?v=63",
  "./js/questions-data.js?v=63",
  "./js/country-questions-data.js?v=63",
  "./js/bosses-data.js?v=63",
  "./js/chain-data.js?v=63",
  "./js/boss-maps.js?v=63",
  "./js/game.js?v=63",
  "./js/access-gate.js?v=63",
  "./assets/d3.min.js",
