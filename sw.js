...
var PRECACHE = [
  ...
  "./css/styles.css?v=53",
  "./js/sign-lang.js?v=53",
  "./js/orbita-world-map.js?v=53",
  "./js/questions-data.js?v=53",
  "./js/country-questions-data.js?v=53",
  "./js/bosses-data.js?v=53",
  "./js/chain-data.js?v=53",
  "./js/boss-maps.js?v=53",
  "./js/game.js?v=53",
  "./js/access-gate.js?v=53",
  "./assets/d3.min.js",
