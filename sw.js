...
var PRECACHE = [
  ...
  "./css/styles.css?v=60",
  "./js/sign-lang.js?v=60",
  "./js/orbita-world-map.js?v=60",
  "./js/questions-data.js?v=60",
  "./js/country-questions-data.js?v=60",
  "./js/bosses-data.js?v=60",
  "./js/chain-data.js?v=60",
  "./js/boss-maps.js?v=60",
  "./js/game.js?v=60",
  "./js/access-gate.js?v=60",
  "./assets/d3.min.js",
